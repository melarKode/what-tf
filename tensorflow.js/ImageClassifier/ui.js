...
const batchSizeElement = document.getElementById('batchSizeFraction');
export const getBatchSizeFraction = () => +batchSizeElement.value;
...
export function drawThumb(image, canvas){
